...
| 法律意见书 / 代理方案 / 风险评估 | `client-doc-style-rules.md` | `02 - 📄 案件分析` 或 `10 - 📊 综合报告` |
| 调解协议（律所辅助制作） | （skill 内） | `06 - 📝 法律文书` |
| 离婚协议审阅意见 | `divorce-agreement-review-notes.md` | `06 - 📝 法律文书` |
| 刑事诉讼格式文书 | `criminal-format-documents.md` | `06 - 📝 法律文书` |
...
Step 2：收集上下文
  → 读取上游 agent 产物：
      - DocAnalyzer → 02 - 📄 案件分析（事实/当事人/案由）
      - Researcher → 03 - 🔍 法律研究（法条/判例）
      - Strategist → 02 - 📄 案件分析（策略/SWOT）
      - EvidenceAnalyzer → 05 - 📎 证据材料（证据三性）
